...
class Translations{
    public static $EN_TEXTS = [
        ...
        "უკან" => "Back",
        "დაჯავშნე შოურუმი" => "Book Showroom",
        "შეუკვეთე ზარი" => "Request Call",
        ...
        "ვიდეოები" => "Videos",
        "ძებნა" => "Search",
        "ყველა სიახლე" => "All News",
        "ბინის არჩევა" => "Choose Flat",
        "შეუკვეთე"=>"order",
        "გაიგე მეტი"=>"Learn more",
        "პოპულარული ბინები"=>"Popular apartments",
        "მთავარი" => "Home",
        "დარჩენილია"=> "left",
        ...
        "ძიება პარამეტრებით" => "Advanced Search",
        "თავისუფალი ბინები სართულზე" => "Available flats on the floor",
        "ფართობი" => "Area",
        "აირჩიეთ კვადრატულობა" => "Area",
        "საძინებლები" => "Bedrooms",
        "აირჩიეთ საძინებლების რაოდენობა" => "Bedrooms",
    ...
    public static $RU_TEXTS = [
        ...
        "ვიდეოები" => "Видео",
        "ძებნა" => "Поиск",
        "ყველა სიახლე" => "Все новости",
        "ბინის არჩევა" => "Выберите квартиру",
        "შეუკვეთე"=>"заказать",
        "გაიგე მეტი"=>"Узнать больше",
        "პოპულარული ბინები"=>"Популярные квартиры",
        "მთავარი" => "Главная страница",
        "დარჩენილია" => "осталось",

        "გთხოვთ შეიყვანოთ სახელი და ტელეფონის ნომერი სწორად." => "пожалуйста, введите имя и номер правильно",
        ...
        "დაჯავშნე შოურუმი" => "бронировать зал",
        "შეუკვეთე ზარი" => "заказать звонок",
        "გთხოვთ შეიყვანოთ სახელი, მეილი და შეტყობინება სწორად." => "Пожалуйста, введите ваше имя, адрес электронной почты и сообщение, правильно",
        "შეტყობინება წარმატებით გაიგზავნა!" => "Сообщение успешно отправлено",
        "შეტყობინება ვერ გაიგზავნა... სცადეთ მოგვიანებით." => "Сообщение не отправлено, повторите попытку позже.",
        "ძიება პარამეტრებით" => "Расширенный поиск",
        "თავისუფალი ბინები სართულზე" => "Доступные квартиры на этаже",
        "ფართობი" => "Область",
        "აირჩიეთ კვადრატულობა" => "Область",
        "საძინებლები" => "Спальни",
        "აირჩიეთ საძინებლების რაოდენობა" => "Спальни",
        "თავისუფალი" => "Свободно",
        "გაყიდული" => "Продано",
        "სტატუსი" => "Статус"
    ];
